...
//         username,
//         password,
//         email, // include email in payload if needed
//       });
...
//       <form
//         onSubmit={handleLogin}
//         className="p-5 rounded-lg bg-gray-100 shadow-2xl h-auto"
//       >
//         <h2 className="font-bold text-3xl text-blue-800 mb-5">Login</h2>
...
//           type="email"
//           placeholder="Email"
//           className="block w-full text-indigo-700 p-2 rounded-sm mb-4 outline outline-1 outline-indigo-300 font-semibold"
//           value={email}
...
//           <button
//             type="submit"
//             className="p-2 font-semibold text-white bg-green-600 rounded w-48"
//           >
//             Sign In
//           </button>
//           <button
