...
//             try {
//                 const res = await axios.get(`https://onlineassessmenttool.onrender.com/api/completed-users`, {
    ...
    const fetchUserData = async () => {
      try {
        ...
        const res = await axios.get(
          `https://onlineassessmenttool.onrender.com/api/completed-users?moduleName=${moduleName}&level=${level}`
        );
