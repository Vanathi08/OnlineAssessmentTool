...
const TakeTest = () => {
  ...
  const fetchAttemptCount = async () => {
    try {
      const res = await axios.get(`https://onlineassessmenttool.onrender.com/api/user-progress/${username}/${moduleName}/${level}`);
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const res = await axios.get(`https://onlineassessmenttool.onrender.com/api/test-questions/${moduleName}/${level}`);
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await axios.post("https://onlineassessmenttool.onrender.com/api/test-submit", {
        username,
        moduleName,
        level,
        userAnswers,
